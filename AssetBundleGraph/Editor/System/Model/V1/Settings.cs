...
namespace AssetBundleGraph {
	public class Settings {
		...
		*/
		...
		public const string GUI_TEXT_MENU_OPEN = "Window/AssetBundle Workflow/AssetBundleGraph/Open Graph Editor";
		public const string GUI_TEXT_MENU_BUILD = "Window/AssetBundle Workflow/AssetBundleGraph/Build Bundles for Current Platform";
		public const string GUI_TEXT_MENU_GENERATE = "Window/AssetBundle Workflow/AssetBundleGraph/Create Node Script";
		...
		public const string GUI_TEXT_MENU_GENERATE_CUITOOL = "Window/AssetBundle Workflow/AssetBundleGraph/Create CUI Tool";

		public const string GUI_TEXT_MENU_GENERATE_POSTPROCESS = GUI_TEXT_MENU_GENERATE + "/Postprocess Script";
		public const string GUI_TEXT_MENU_DELETE_CACHE = "Window/AssetBundle Workflow/AssetBundleGraph/Clear Build Cache";
		
		public const string GUI_TEXT_MENU_DELETE_IMPORTSETTING_SETTINGS = "Window/AssetBundle Workflow/AssetBundleGraph/Clear Saved ImportSettings";
            ...
            public static string BasePath {
                get {
                    if (string.IsNullOrEmpty (s_basePath)) {
                        ...
                        Assert.AreEqual ("AssetBundleGraph", baseDir.Name);
